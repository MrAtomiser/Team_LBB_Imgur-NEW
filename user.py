    ...
    for image in self.my_images:
      if title in image.title:
        print(image)
                ...
                tomi = User(username = "tomi", password = hashlib.md5("password".encode('utf-8')).hexdigest(), email='oluwatomisin.adeshiyan@meltwater.org', profile_image="tomiimage",my_images = [])
                abdul = User(username = "abdul", password = hashlib.md5("password".encode('utf-8')).hexdigest(), email='abdulquadri.sotomiwa@meltwater.org', profile_image="abdulimage",my_images = [])
                dare = User(username = "dare", password = hashlib.md5("password".encode('utf-8')).hexdigest(), email='draogtech@gmail.com', profile_image="dareimage",my_images = [])
                charles = User(username = "charles", password = hashlib.md5("password".encode('utf-8')).hexdigest(), email='charles.thompson@meltwater.org',profile_image="charlesimage",my_images = [])
